                ...
                if (isset($clave)) {
                    ...
                    if ($result) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            $nombre = $row['nombre'];
                            echo "<p>Usuario a modificar: $nombre</p>";
                        }
                    } else {
                    ...
                    echo "<table>
                        <tbody>
                            <tr>
                                <td>Nombre:</td>
                                <td>
                                    <input type='text' name='nombre' size='40' maxlength='40' value='$nombre' required/>
                                </td>
                            </tr>
                            <tr>
                                <td>Direcci&oacute;n:</td>
                                <td>
                                    <input type='text' name='direccion' size='60' maxlength='60' value='$dir' required/>
                                </td>
                                <td>Telefono</td>
                                <td>
                                    <input type='text' name='telefono' size='15' maxlength='15' value='$telefono' required/>
                                </td>
                            </tr>
                        </tbody>
                    </table>";
