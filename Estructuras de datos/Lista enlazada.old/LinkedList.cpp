...
int main() {
    ...
    Validador<float> validadorFloat;
    Validador<string> validadorString;
    int opcion;
    do{
        ...
        switch (opcion) {
            case 1: {
                List<int> list(validadorInt);
                Menu<int> menu(list);
                menu.menuNumeros(list);
                break;
            }
            case 2: {
                List<float> list(validadorFloat);
                Menu<float> menu(list);
                menu.menuNumeros(list);
                break;
            }
            case 3: {
                List<string> list(validadorString);
